-- ROBLOX upstream: https://github.com/facebook/jest/blob/v27.4.7/packages/jest-circus/src/__mocks__/testUtils.ts
--[[*
...
local function runTest(source: string)
	local content = ([[
		return function(script_)
			...
			local LuauPolyfill = require(script_.Parent.Parent.Parent.LuauPolyfill)
