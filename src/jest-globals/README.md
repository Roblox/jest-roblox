...
This package exports the "global" methods used by Jest (`describe`, `it`, `test`, `expect`, `beforeEach`, etc.). See the [Jest documentation](https://roblox.github.io/jest-roblox) for full API docs.
