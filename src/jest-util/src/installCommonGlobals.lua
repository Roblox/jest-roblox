...
exports.default = function(globalObject: typeof(_G), globals: Config_ConfigGlobals): typeof(_G) & Config_ConfigGlobals
	...
	Array.forEach(DTRACE, function(dtrace)
		...
		globalObject[tostring(dtrace)] = function(_self, ...: any)
			local args = { ... }
			-- @ts-expect-error: no index
			return _G[tostring(dtrace)](self, table.unpack(args))
		end
	end)
