...
itFIXME("once() - eventName must be a string, symbol, or number", function()
	return Promise.resolve()
		:andThen(function()
			...
			emitter:once(42)
			t:throwsAsync(emitter:once("true", function() end), Error):expect()
		end)
		:expect()
end)
...
itFIXME("emit() - eventName must be a string, symbol, or number", function()
	return Promise.resolve()
		:andThen(function()
			...
			emitter:emit(42)
			t:throwsAsync(emitter:emit(true), Error):expect()
		end)
		:expect()
end)
...
itFIXME("emit() - userland cannot emit the meta events", function()
	return Promise.resolve()
		:andThen(function()
			local emitter = Emittery.new()
			t:throwsAsync(emitter:emit(Emittery.listenerRemoved), Error):expect()
			t:throwsAsync(emitter:emit(Emittery.listenerAdded), Error):expect()
		end)
		:expect()
end)
...
itFIXME("emitSerial() - eventName must be a string, symbol, or number", function()
	return Promise.resolve()
		:andThen(function()
			...
			t:throwsAsync(emitter:emitSerial(true), Error):expect()
		end)
		:expect()
end)
...
itFIXME("emitSerial() - userland cannot emit the meta events", function()
	return Promise.resolve()
		:andThen(function()
			local emitter = Emittery.new()
			t:throwsAsync(emitter:emitSerial(Emittery.listenerRemoved), Error):expect()
			t:throwsAsync(emitter:emitSerial(Emittery.listenerAdded), Error):expect()
		end)
		:expect()
end)
