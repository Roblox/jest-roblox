-- upstream: https://github.com/facebook/jest/blob/v26.5.3/packages/jest-snapshot/src/printSnapshot.ts
-- /**
...
local getObjectSubset = require(Modules.Expect.utils).getObjectSubset
