...
return function()
	...
	do
		...
		it(string.format("supports nested any(%s)", type_), function()
			...
			expect(result).to.equal(string.format('Table {\n  "test": Table {\n    "nested": Any<%s>,\n  },\n}', type_))
		end)
	end
